...
public class Adapter_Reply extends RecyclerView.Adapter<Adapter_Reply.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if((position % 4) == 1){
            ...
            holder.ll_reply.setBackgroundResource(R.color.colorCenter);
        }else if((position %4 == 3)){
            holder.ll_reply.setBackgroundResource(R.color.colorRight);
        }else{
            holder.ll_reply.setBackgroundResource(R.color.colorStart);
        }
    }
