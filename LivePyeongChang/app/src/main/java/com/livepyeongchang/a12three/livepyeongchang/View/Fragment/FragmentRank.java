...
public class FragmentRank extends Fragment {
    ...
    private TextView txt_object_kor;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txt_object_kor=(TextView)rootView.findViewById(R.id.txt_object_kor);
    ...
    public void settingKor(){
        ...
        if(MainActivity.isKorean) {
            ...
            txt_object_kor.setText("한국 대표팀 목표 종합 7위");
        }else{
            if(korea.getRank()==1){
                txt_object_kor.setText("Korea team's goal is total 7th");
